      ...
      <div class="site-wrapper-inner">
        ...
        <div class="cover-container">
          ...
          <div style="text-align: left;" class="inner cover">
            ...
            <p>
This site is a technology demonstration of a Credential Issuer.
It allows you to login using the Identity Credentials login protocol and
assign credentials to your identity. The technology is based on a set of
specifications that are being developed as a part of the
